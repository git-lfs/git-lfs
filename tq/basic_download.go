...
func (a *basicDownloadAdapter) DoTransfer(ctx interface{}, t *Transfer, cb ProgressCallback, authOkFunc func()) error {
	...
	if err != nil {
		...
		tools.RenameNoReplace(f.Name(), a.downloadFilename(t))
	}
...
func (a *basicDownloadAdapter) download(t *Transfer, cb ProgressCallback, authOkFunc func(), dlFile *os.File, fromByte int64, hash hash.Hash) error {
	...
	err = tools.RenameNoReplace(dlfilename, t.Path)
	// If rename failed because file already exists, we do not treat it as error
	// This can happen when multiple git-lfs processes are fetching files concurrently
