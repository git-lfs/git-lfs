...
func init() {
	...
	importCmd.Flags().BoolVar(&migrateRewriteCommitHashesInCommitMessages, "rewrite-commit-hashes-in-commit-messages", false, "Rewrite commit hashes in commit messages")
	...
	exportCmd.Flags().BoolVar(&migrateRewriteCommitHashesInCommitMessages, "rewrite-commit-hashes-in-commit-messages", false, "Rewrite commit hashes in commit messages")
