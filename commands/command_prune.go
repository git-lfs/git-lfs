...
func pruneTaskDisplayProgress(progressChan PruneProgressChan, waitg *sync.WaitGroup, spinner *tlog.Spinner) {
	defer waitg.Done()
...
func pruneDeleteFiles(prunableObjects []string, spinner *tlog.Spinner) {
	var problems bytes.Buffer
