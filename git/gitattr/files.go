...
// workingDir is the root of the working copy
// gitDir is the root of the git repo
func GetAttributeFilter(cfg filepathfilter.Environment, workingDir, gitDir string) *filepathfilter.Filter {
	...
	for _, path := range paths {
		...
		patterns = append(patterns, filepathfilter.NewPattern(filepath.ToSlash(path.Path), filepathfilter.GitAttributes, cfg))
	}
