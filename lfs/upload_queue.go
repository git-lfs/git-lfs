...
func NewUploadQueue(files int, size int64, metadata *api.BatchMetadata, dryRun bool) *TransferQueue {
	return newTransferQueue(transfer.Upload, files, size, metadata, dryRun)
}
