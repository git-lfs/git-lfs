...
func TestLogScannerAdditionsFilterInclude(t *testing.T) {
	r := strings.NewReader(pointerParseLogOutput)
	scanner := newLogScanner(LogDiffAdditions, r)
	scanner.Filter = filepathfilter.New([]string{"wave*"}, nil, filepathfilter.GitAttributes, filepathfilter.NewFakeEnvironment())
...
func TestLogScannerAdditionsFilterIncludeOctals(t *testing.T) {
	r := strings.NewReader(pointerParseLogOutput)
	scanner := newLogScanner(LogDiffAdditions, r)
	scanner.Filter = filepathfilter.New([]string{"*ç*"}, nil, filepathfilter.GitAttributes, filepathfilter.NewFakeEnvironment())
...
func TestLogScannerAdditionsFilterExclude(t *testing.T) {
	r := strings.NewReader(pointerParseLogOutput)
	scanner := newLogScanner(LogDiffAdditions, r)
	scanner.Filter = filepathfilter.New(nil, []string{"wave*"}, filepathfilter.GitAttributes, filepathfilter.NewFakeEnvironment())
...
func TestLogScannerDeletionsFilterInclude(t *testing.T) {
	r := strings.NewReader(pointerParseLogOutput)
	scanner := newLogScanner(LogDiffDeletions, r)
	scanner.Filter = filepathfilter.New([]string{"flare*"}, nil, filepathfilter.GitAttributes, filepathfilter.NewFakeEnvironment())
...
func TestLogScannerDeletionsFilterExclude(t *testing.T) {
	r := strings.NewReader(pointerParseLogOutput)
	scanner := newLogScanner(LogDiffDeletions, r)
	scanner.Filter = filepathfilter.New(nil, []string{"flare*"}, filepathfilter.GitAttributes, filepathfilter.NewFakeEnvironment())
