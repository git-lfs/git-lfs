...
documentation for
link:https://git-scm.com/docs/git-config#Documentation/git-config.txt-httplturlgt[`http.<url>.*`]
settings.
+
Example: `git config lfs.transfer.httpDownloadEncoding "zstd"`
+
Example (URL-specific):
+
....
